 ...
 */
final class Version20220222174423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_292FFF1DF8646701 ON vehicule (livreur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_292FFF1DF8646701 ON vehicule');
