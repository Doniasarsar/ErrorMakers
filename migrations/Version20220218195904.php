 ...
 */
final class Version20220218195904 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande DROP quantite, CHANGE id_commande id_commande VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE id_produit id_produit VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
