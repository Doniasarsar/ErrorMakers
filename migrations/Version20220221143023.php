 ...
 */
final class Version20220221143023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande DROP id_commande');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande ADD id_commande VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
