 ...
 */
final class Version20220221103345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demandes ADD etat VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE utilisateurs ADD etat VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs DROP etat, CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE prenom prenom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE password password VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE role role LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:json)\', CHANGE question_securite1 question_securite1 VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE question_securite2 question_securite2 VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
