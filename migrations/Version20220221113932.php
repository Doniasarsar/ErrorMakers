 ...
 */
final class Version20220221113932 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ligne_commande ADD produit_id INT DEFAULT NULL, CHANGE id_commande id_commande VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE id_produit id_produit VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
