 ...
 */
final class Version20220220205210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD question_securite1 VARCHAR(255) NOT NULL, ADD question_securite2 VARCHAR(255) NOT NULL');
    }
