...
#***************************MOBILE*******************************#
    ...
    {  
      ...
      /**
     * @Route("/deleteCommentairess", name="jsondeletecomms")
     * @Method("DELETE")
     */
    public function deleteCommantaire(Request $request,CommentairesRepository $rep)
    {
        $id = $request->get("id");
        ...
        return new JsonResponse("id comm invalid");
