...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getLivraisonControlleurService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/LivraisonControlleur.php';
    ...
    protected function getActeurSTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/ActeurSType.php';
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderc6ac4 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerc201d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties87025 = [
        
    ];

    public function getConnection()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getConnection', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getMetadataFactory', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getExpressionBuilder', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'beginTransaction', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getCache', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getCache();
    }

    public function transactional($func)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'transactional', array('func' => $func), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'wrapInTransaction', array('func' => $func), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'commit', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->commit();
    }

    public function rollback()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'rollback', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getClassMetadata', array('className' => $className), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'createQuery', array('dql' => $dql), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'createNamedQuery', array('name' => $name), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'createQueryBuilder', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'flush', array('entity' => $entity), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'clear', array('entityName' => $entityName), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->clear($entityName);
    }

    public function close()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'close', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->close();
    }

    public function persist($entity)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'persist', array('entity' => $entity), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'remove', array('entity' => $entity), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'refresh', array('entity' => $entity), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'detach', array('entity' => $entity), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'merge', array('entity' => $entity), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getRepository', array('entityName' => $entityName), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'contains', array('entity' => $entity), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getEventManager', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getConfiguration', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'isOpen', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getUnitOfWork', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getProxyFactory', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'initializeObject', array('obj' => $obj), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'getFilters', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'isFiltersStateClean', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'hasFilters', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return $this->valueHolderc6ac4->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerc201d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderc6ac4) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderc6ac4 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderc6ac4->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, '__get', ['name' => $name], $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        if (isset(self::$publicProperties87025[$name])) {
            return $this->valueHolderc6ac4->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderc6ac4;
    ...
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;
    ...
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, '__isset', array('name' => $name), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;
    ...
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, '__unset', array('name' => $name), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;
    ...
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, '__clone', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        $this->valueHolderc6ac4 = clone $this->valueHolderc6ac4;
    }

    public function __sleep()
    {
        $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, '__sleep', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;

        return array('valueHolderc6ac4');
    }
    ...
    {
        $this->initializerc201d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerc201d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerc201d && ($this->initializerc201d->__invoke($valueHolderc6ac4, $this, 'initializeProxy', array(), $this->initializerc201d) || 1) && $this->valueHolderc6ac4 = $valueHolderc6ac4;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderc6ac4;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderc6ac4;
    }
}
