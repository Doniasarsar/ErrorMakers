  ...
  <div class=\"content-wrapper\">
    ...
    <section class=\"content\">
      <div class=\"container-fluid\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["tab"]) || array_key_exists("tab", $context) ? $context["tab"] : (function () { throw new RuntimeError('Variable "tab" does not exist.', 53, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["evenement"]) {
            // line 54
            echo "                  <tr>
                    <td>";
            // line 55
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "nom", [], "any", false, false, false, 55), "html", null, true);
            echo "</td>
                    <td>";
            // line 56
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "prix", [], "any", false, false, false, 56), "html", null, true);
            echo "</td>
                    <td>";
            // line 57
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "adresse", [], "any", false, false, false, 57), "html", null, true);
            echo "</td>
                    <td>";
            // line 58
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "date", [], "any", false, false, false, 58), "d/m/Y"), "html", null, true);
            echo "</td>
                    <td>";
            // line 59
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "datefin", [], "any", false, false, false, 59), "d/m/Y"), "html", null, true);
            echo "</td>
                    <td>";
            // line 60
            ...
            echo "</td>
                    <td>";
            // line 61
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "longdesc", [], "any", false, false, false, 61), "html", null, true);
            echo "</td>
                    <td><img src=\"";
            // line 62
            echo twig_escape_filter($this->env, ($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("uploads/") . twig_get_attribute($this->env, $this->source, $context["evenement"], "affiche", [], "any", false, false, false, 62)), "html", null, true);
            echo "\"  width=\"100\" height=\"100\"></td>
                     <td>
                        <a class=\"btn btn-info\" href=\"";
            // line 64
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("ev_update", ["id" => twig_get_attribute($this->env, $this->source, $context["evenement"], "id", [], "any", false, false, false, 64)]), "html", null, true);
            echo "\">Modifier</a>
                        <a class=\"btn btn-warning\"  href=\"";
            // line 65
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("ev_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["evenement"], "id", [], "any", false, false, false, 65)]), "html", null, true);
            echo "\">Supprimer</a>
                         <a class=\"btn btn-warning\"  href=\"";
            // line 66
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("commentaires", ["id" => twig_get_attribute($this->env, $this->source, $context["evenement"], "id", [], "any", false, false, false, 66)]), "html", null, true);
            echo "\">Commentaires</a>
...
";
    ...
    {
        return array (  271 => 107,  267 => 106,  263 => 105,  259 => 104,  255 => 103,  251 => 102,  247 => 101,  243 => 100,  239 => 99,  235 => 98,  231 => 97,  227 => 96,  221 => 93,  211 => 92,  184 => 73,  171 => 66,  167 => 65,  163 => 64,  158 => 62,  154 => 61,  150 => 60,  146 => 59,  142 => 58,  138 => 57,  134 => 56,  130 => 55,  127 => 54,  123 => 53,  102 => 35,  69 => 4,  59 => 3,  36 => 1,);
    }
                    ...
                    <td><img src=\"{{asset('uploads/') ~ evenement.affiche}}\"  width=\"100\" height=\"100\"></td>
                     <td>
                        ...
                        <a class=\"btn btn-warning\"  href=\"{{path('ev_delete',{id : evenement.id })}}\">Supprimer</a>
                         <a class=\"btn btn-warning\"  href=\"{{path('commentaires',{id : evenement.id })}}\">Commentaires</a>
