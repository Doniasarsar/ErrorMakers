...
return [
    ...
    'r_delete' => [['id'], ['_controller' => 'App\\Controller\\LivraisonControlleur::Supprimer'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/admin/livraison/delete']], [], []],
    'liv_add' => [['id'], ['_controller' => 'App\\Controller\\LivraisonControlleur::Add'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/admin/livraison/add']], [], []],
    'r_update' => [['id'], ['_controller' => 'App\\Controller\\LivraisonControlleur::Update'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/admin/livraison/update']], [], []],
