...
return [
    ...
    'voi_delete' => [['id'], ['_controller' => 'App\\Controller\\VehiculeController::SupprimerVoiture'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/voiture/delete']], [], []],
    'mot_delete' => [['id'], ['_controller' => 'App\\Controller\\VehiculeController::SupprimerMoto'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/moto/delete']], [], []],
    'cam_delete' => [['id'], ['_controller' => 'App\\Controller\\VehiculeController::SupprimerCamion'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/camion/delete']], [], []],
