...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder0e9c5 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerc3f76 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties7d12c = [
        
    ];

    public function getConnection()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getConnection', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getMetadataFactory', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getExpressionBuilder', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'beginTransaction', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getCache', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getCache();
    }

    public function transactional($func)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'transactional', array('func' => $func), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'wrapInTransaction', array('func' => $func), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'commit', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->commit();
    }

    public function rollback()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'rollback', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getClassMetadata', array('className' => $className), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'createQuery', array('dql' => $dql), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'createNamedQuery', array('name' => $name), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'createQueryBuilder', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'flush', array('entity' => $entity), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'clear', array('entityName' => $entityName), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->clear($entityName);
    }

    public function close()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'close', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->close();
    }

    public function persist($entity)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'persist', array('entity' => $entity), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'remove', array('entity' => $entity), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'refresh', array('entity' => $entity), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'detach', array('entity' => $entity), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'merge', array('entity' => $entity), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getRepository', array('entityName' => $entityName), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'contains', array('entity' => $entity), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getEventManager', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getConfiguration', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'isOpen', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getUnitOfWork', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getProxyFactory', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'initializeObject', array('obj' => $obj), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'getFilters', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'isFiltersStateClean', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'hasFilters', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return $this->valueHolder0e9c5->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerc3f76 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder0e9c5) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder0e9c5 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder0e9c5->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, '__get', ['name' => $name], $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        if (isset(self::$publicProperties7d12c[$name])) {
            return $this->valueHolder0e9c5->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder0e9c5;
    ...
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;
    ...
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, '__isset', array('name' => $name), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;
    ...
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, '__unset', array('name' => $name), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;
    ...
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, '__clone', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        $this->valueHolder0e9c5 = clone $this->valueHolder0e9c5;
    }

    public function __sleep()
    {
        $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, '__sleep', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;

        return array('valueHolder0e9c5');
    }
    ...
    {
        $this->initializerc3f76 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerc3f76;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerc3f76 && ($this->initializerc3f76->__invoke($valueHolder0e9c5, $this, 'initializeProxy', array(), $this->initializerc3f76) || 1) && $this->valueHolder0e9c5 = $valueHolder0e9c5;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder0e9c5;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder0e9c5;
    }
}
