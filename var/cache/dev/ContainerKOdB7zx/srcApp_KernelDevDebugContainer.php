...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_Authentication_Listener_Form_MainService()
    {
        ...
        $b->setOptions(['login_path' => 'login', 'default_target_path' => 'acteurSAdd', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false]);
